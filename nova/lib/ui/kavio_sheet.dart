...
Future<T?> showKavioSheet<T>(
  ...
  return showModalBottomSheet<T>(
    ...
    // Кореневий навігатор: інакше лист відкривається всередині вкладки й
    // плаваючий нав-бар лишається поверх нього. Модалка має накривати все.
    useRootNavigator: true,
    backgroundColor: kavio.surface,
    showDragHandle: true,
    // Високий лист (картка запису, перенесення) має право зайняти майже весь
    // екран — контент усередині прокручується сам.
