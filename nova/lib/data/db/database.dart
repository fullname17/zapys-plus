...
class AppDatabase extends _$AppDatabase {
  ...
  /// прив'язаними до того самого запису.
  Future<void> updateAppointment(domain.Appointment a) {
    return (update(appointments)..where((t) => t.id.equals(a.id))).write(
      AppointmentsCompanion(
        clientId: Value(a.client.id),
        serviceId: Value(a.service.id),
        staffId: Value(a.staff?.id),
        resourceId: Value(a.resource?.id),
