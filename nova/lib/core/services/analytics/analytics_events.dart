...
class AnalyticsEvent {
  ...
  static const appointmentEdited = AnalyticsEvent('appointment_edited');
  static const appointmentCancelled = AnalyticsEvent('appointment_cancelled');
  static const appointmentRestored = AnalyticsEvent('appointment_restored');
